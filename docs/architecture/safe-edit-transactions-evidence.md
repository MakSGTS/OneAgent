...
Current implementation evidence qualifies `56fad47bf5c290011e32c4c304cb4639f64ca3ee`
...
| T35 Complete publication baseline and bounds before retention; Local API, authorization and lifetime | W:857 prepare_edit_baseline; W:868 finish_edit_baseline; W:1014 successor lifecycle; E:710 prepare | Edit-enabled initial instability fails startup; unstable successor retains predecessor/no increment. An unprovable or over-bound edit baseline never permits preparation; otherwise valid read-only evidence remains read-only. Preserve otherwise eligible Query-containing targets without blanket rejection. Every accepted nontransaction successor invalidates prepared challenge/authorization/undo; no time-based or cross-process credential exists. | [`publication_baseline_admission`](../../apps/runtime/src/workspace/edit.rs) (`apps/runtime/src/workspace/edit.rs:4391`): unstable before/after startup, rebuild and validated cache hit cannot become edit-eligible; over-bound baseline denies preparation; a watcher/explicit-input successor expires retained challenge and undo. Existing default read-only lifecycle remains valid. | F3, F5, F7 |
...
oracles: 59 unique functions. This follow-on checked each
...
| `attempt_lifetime_and_bounds` | [`apps/runtime/src/workspace/edit.rs:2064`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `buffer_and_disk_bounds_precede_allocation` | [`apps/runtime/src/workspace/edit_io.rs:1047`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
| `cache_namespace_and_scan_exclusions` | [`apps/runtime/src/workspace/edit.rs:5102`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `cancellation_drop_and_shutdown_join` | [`apps/runtime/src/workspace/edit.rs:4235`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `closed_precedence_and_redaction` | [`apps/runtime/src/workspace/edit.rs:4363`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `confinement_rechecked_at_every_io_boundary` | [`apps/runtime/src/workspace/edit_io.rs:1491`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
...
| `final_cleanup_scan_and_commit_barrier` | [`apps/runtime/src/workspace/edit.rs:2512`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `policy_gate_is_exact_confirmed_and_side_effect_free` | [`apps/runtime/src/workspace/edit.rs:4148`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `post_write_build_and_tree_failures_recover` | [`apps/runtime/src/workspace/edit.rs:2473`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `projection_freeze_precedes_io` | [`apps/runtime/src/workspace/edit.rs:2227`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `publication_barriers_and_overflow` | [`apps/runtime/src/workspace/edit.rs:2247`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `publication_baseline_admission` | [`apps/runtime/src/workspace/edit.rs:4391`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `recovery_ordinals_preserve_unrelated_edits` | [`apps/runtime/src/workspace/edit_io.rs:1411`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
| `recovery_outcomes_and_precedence` | [`apps/runtime/src/workspace/edit.rs:2534`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `replacement_ordinals_classify_ambiguous_failure` | [`apps/runtime/src/workspace/edit_io.rs:1371`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
...
| `reversal_failures_restore_applied_state` | [`apps/runtime/src/workspace/edit.rs:2709`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `scan_bounds_precede_retention` | [`apps/runtime/src/workspace/edit_io.rs:833`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
| `semantic_candidate_faults_recover` | [`apps/runtime/src/workspace/edit.rs:3857`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `staging_faults_preserve_sources` | [`apps/runtime/src/workspace/edit_io.rs:1175`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
...
| `structured_plan_and_capability_tampering_reject` | [`apps/runtime/src/workspace/edit.rs:3945`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `every_read_ordinal_fails_through_real_io_routes` | [`apps/runtime/src/workspace/edit_io.rs:1114`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
...
| `ordinary_rebuild_cache_keeps_admission_busy` | [`apps/runtime/src/workspace/edit.rs:5021`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `policy_rejections_never_enter_mutation_queue` | [`apps/runtime/src/workspace/edit.rs:4955`](../../apps/runtime/src/workspace/edit.rs) | F3 |
...
| `queued_cancellation_precedes_changed_predecessor` | [`apps/runtime/src/workspace/edit.rs:4683`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `queued_payload_remains_revocable_until_worker_claim` | [`apps/runtime/src/workspace/edit.rs:4811`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `retained_capabilities_release_payload_on_successor_and_stop` | [`apps/runtime/src/workspace/edit.rs:4584`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `reversal_read_ordinals_fail_closed` | [`apps/runtime/src/workspace/edit.rs:2582`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `shared_raw_projection_lease_survives_io_and_undo` | [`apps/runtime/src/workspace/edit.rs:4880`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `submit_availability_precedes_expired_or_malformed_capability` | [`apps/runtime/src/workspace/edit.rs:4751`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `existing_second_configuration_semantic_change_recovers` | [`apps/runtime/src/workspace/edit.rs:3695`](../../apps/runtime/src/workspace/edit.rs) | F3 |
| `original_one_over_document_bound_rejects_admissible_result` | [`apps/runtime/src/workspace/edit_io.rs:1001`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
...
| `created_file_identity_failures_retain_exact_ownership` | [`apps/runtime/src/workspace/edit_io.rs:1249`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
| `created_file_identity_rejection_never_adopts_an_alias` | [`apps/runtime/src/workspace/edit_io.rs:1348`](../../apps/runtime/src/workspace/edit_io.rs) | F4 |
| `created_file_identity_failures_require_recovery` | [`apps/runtime/src/workspace/edit.rs:2565`](../../apps/runtime/src/workspace/edit.rs) | F3 |
