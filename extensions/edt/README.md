...
verification runs 38 tests with zero failures, errors, or skips; one of those
tests starts the real Runtime twice. A skipped real-process test is not complete
acceptance evidence.

The package auditor requires all eight Surefire suites and exactly 38 tests with
